...
public class BaseNetService {
	...
	/**  **/
	public static final String URL_RESULT_LIST = HOST_PORT
			+ "queryevaluationperiods";

	/** **/
	public static final String URL_MY_RESULT = HOST_PORT
			+ "queryevaluation";
	
	/** **/
	public static final String URL_SALE_POOL = HOST_PORT
			+ "queryresalepool";
	
	
	/** **/
	public static final String URL_SALE_FUXIAO = HOST_PORT
			+ "queryrepeatepool";
