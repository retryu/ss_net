...
public class Order {
	...
	public String toString() {
		return "Order [storeid=" + storeid + ", bianhao=" + bianhao
				+ ", ubianhao=" + ubianhao + ", username=" + username
				+ ", fhtype=" + fhtype + ", hometel=" + hometel
				+ ", mobiletel=" + mobiletel + ", address=" + address
				+ ", receiver=" + receiver + ", totalamt=" + totalamt
				+ ", totalpv=" + totalpv + ", sysflag=" + sysflag
				+ ", ordertype=" + ordertype + ", paytype=" + paytype
